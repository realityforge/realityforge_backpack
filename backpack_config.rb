...
Backpack.organization('realityforge') do |o|
  ...
  o.repository('gwt-appcache', :description => 'GWT AppCache Support Library', :homepage => 'http://realityforge.github.io/gwt-appcache/', :tags => %w(travis))
  o.repository('gwt-appcache-example', :description => 'A simple application demonstrating the use of the gwt-appcache library')
  o.repository('gwt-cache-filter', :description => 'A servlet filter that adds the appropriate http caching headers to GWT generated files based on *.cache.* and *.nocache.* naming patterns.')
  ...
  o.repository('gwt-eventsource', :description => 'GWT EventSource Library')
  o.repository('gwt-eventsource-example', :description => 'A simple application demonstrating the use of the gwt-eventsource library')
  o.repository('gwt-ga', :description => 'A simple GWT library for interacting with Google Analytics')
  o.repository('gwt-keycloak', :description => 'A simple library to provide keycloak support to GWT')
  ...
  o.repository('gwt-property-source', :description => 'Provides a convenient way of compiling GWT property values into your module.')
  o.repository('gwt-property-source-example', :description => 'A sample application that demonstrates the use of the gwt-property-source')
  o.repository('gwt-webpoller', :description => 'A gwt library to simplify periodic polling and long-poll based transport layers')
  o.repository('gwt-webpoller-example', :description => 'A simple application demonstrating the use of the gwt-webpoller library')
  o.repository('gwt-websockets', :description => 'GWT WebSocket Library')
  o.repository('gwt-websockets-example', :description => 'A simple application demonstrating the use of the gwt-websockets library')
