...
Belt.scope('spritz') do |o|
  o.project('streak', :description => 'A browser based, reactive event streaming library that is best used when coordinating events', :tags => %w(travis issues homepage=https://spritz.github.io))
