Belt.scope('react4j') do |o|
  ...
  o.project('react4j-todomvc', :description => 'React4j TodoMVC implementation', :tags => %w(travis homepage=https://react4j.github.io/docs/todomvc.html zim:branches=raw,arez,dagger,sting,spritz,raw_bazel,raw_bazel_j2cl,sting_maven,sting_maven_j2cl))
