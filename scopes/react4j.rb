Belt.scope('react4j') do |o|
  ...
  o.project('react4j-todomvc', :description => 'React4j TodoMVC implementation', :tags => %w(travis homepage=https://react4j.github.io/docs/todomvc.html zim:branches=raw,arez,dagger,sting,spritz,raw_bazel,raw_bazel_j2cl,raw_maven,arez_maven,dagger_maven,raw_maven_j2cl,arez_maven_j2cl,dagger_maven_j2cl))
