Belt.scope('realityforge') do |o|
  ...
  o.project('MetaWeaver', :description => 'Typed, validated, bulk-editable asset metadata editors for Unreal Engine', :tags => %w(default_branch=main issues projects homepage=https://realityforge.org/MetaWeaver/))
