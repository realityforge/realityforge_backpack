Belt.scope('realityforge') do |o|
  ...
  o.project('course-unreal-engine-5-advanced-action-rpg', :description => 'Coursework for "Unreal Engine 5 C++: Advanced Action RPG"', :tags => %w(default_branch=main zim=no issues))
