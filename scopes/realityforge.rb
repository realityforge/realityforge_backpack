Belt.scope('realityforge') do |o|
  ...
  o.project('proton-processor-pack', :description => 'Utilities for building annotation processors', :tags => %w(travis))
  o.project('sting', :description => 'A simple, compile-time dependency injection toolkit', :tags => %w(travis))
