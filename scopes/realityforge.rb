Belt.scope('realityforge') do |o|
  ...
  o.project('way_of_realityforge', :tags => %w(homepage=https://realityforge.org/way_of_realityforge/ default_branch=main))
  ...
  o.project('course-unreal-engine-the-ultimate-shooter', :description => 'Course work for "Unreal Engine C++ The Ultimate Shooter Course"', :tags => %w(default_branch=main issues))
  ...
  o.project('phd-progress-reports', :tags => %w(private default_branch=main historic))
  ...
  o.project('glfw-test', :tags => %w(default_branch=main historic))
