Belt.scope('realityforge') do |o|
  ...
  o.project('course-blender-fundamentals-modeling', :description => 'Course work for "Blender Fundamentals - Modeling"', :tags => %w(default_branch=main))
  ...
  o.project('phd-thesis', :tags => %w(private default_branch=main))
  o.project('phd-code', :tags => %w(private default_branch=main))
