...
command(:patch_sting_version) do |app|
  patch_versions(app, %w(org.realityforge.sting:sting-core:jar org.realityforge.sting:sting-processor:jar), '0.06')
end
...
command(:patch_jetbrains_annotations_version) do |app|
  patch_versions(app, %w(org.realityforge.org.jetbrains.annotations:org.jetbrains.annotations:jar), '1.5.0')
end
...
command(:patch_proton_version) do |app|
  patch_versions(app, %w(org.realityforge.proton:proton-core:jar org.realityforge.proton:proton-qa:jar), '0.50')
end
...
command(:patch_arez_spytools_version) do |app|
  patch_versions(app, %w(org.realityforge.arez.spytools:arez-spytools:jar), '0.107')
end

command(:patch_arez_testng_version) do |app|
  patch_versions(app, %w(org.realityforge.arez.testng:arez-testng:jar), '0.12')
end

command(:patch_arez_dom_version) do |app|
  patch_versions(app, %w(org.realityforge.arez.dom:arez-dom:jar), '0.67')
end
